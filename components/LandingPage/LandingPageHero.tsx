    ...
    return (
        <div className={styles.heroContainer}>
            <ShardClip>
              ...
              <img className={styles.image} src={image.url} alt={image.description} width={image.width} height={image.height}/>
            </ShardClip>

            <div className={styles.textContainer}>
                <h1 className={styles.title}>
                <span className={styles.titleAccent}>Being at</span><br/>
                    Torchbox
                </h1>
